...
- (void)testTokens
{
    STAssertEquals(self.document.tokens.count, 1276u, @"Has expected number of tokens");
}

- (void)testTerms
{
    NSLog(@"terms: %@", self.document.terms);
    STAssertEquals(self.document.terms.count, 516u, @"Has expected number of terms");
